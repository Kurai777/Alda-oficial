 ...
 */
export async function processExcelFile(filePath: string, userId: any, catalogId: any): Promise<any[]> {
  try {
    ...
    if (products.length > 0) {
      try {
        ...
        // Primeiro tentar com extrator robusto
        ...
        // Se falhar, tentar com Python
        if (!robustResult.success || robustResult.imageCount === 0) {
          console.log('Tentando extrair com Python...');
